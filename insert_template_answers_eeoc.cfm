...
<!---****************************************************************************************************************************
This module is specifically written for processing the dynamic template called "EEOC Template Ltr Applnt Rep Req Auth final.rtf".
...
template number 78 which is EEOC Template Ltr Applnt Rep Req Auth final.rtf.
     ***************************************************************************************************************--->
	<cfquery name="update_cmft_dynamic_ans" datasource="lawmanager">
	  delete from CMFT_DYNAMIC_ANS where matter_key = #matterkey# and dynamic_quest_key = '23'	  
	</cfquery>



<!---***************************************************************************************************************
Here we insert the answer for radio button for the template EEOC Template Ltr Applnt Rep Req Auth final.rtf. 
The question for the radio button is "Are there allegations directly implicating a work related injury?" 
	...
	is "yes" for "EEOC Template Ltr Applnt Rep Req Auth final.rtf" template, the user input
