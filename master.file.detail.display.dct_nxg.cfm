...
<table align="center" width="85%" border="0" cellspacing="1" cellpadding="1" bgcolor="#ffffff" >
	...
	<td align=right class=TextMaingrcolapan=5 bgcolor="#D9E9EA">	PALO - District Court	
	...
	<tr>
		...
		<td  width=10% align="right" class=TextMaingr>AUSA District1 </td>
		<td width=30%>
	...
	<tr>
		<td  width=10% align="right" class=TextMaingr>PALO Office </td>
		<td width=30%>
	...
	<tr>
		<td align="right" class=TextMaingr>PALO Address1 </td>
		<td>
			...
			<cfif not qry_last_submitted_data.RecordCount gt 0>
				<select name="alo_addr1" size=2 tabindex=25 multiple>
					...
					<option value="1300 Evans Ave., Rm 217" selected="selected">1300 Evans Ave., Rm 217</option>
	...
	<tr>
		<td align="right" class=TextMaingr>PALO  Address2 </td>
		<td>
	...
	<tr>
		<td align="right" class=TextMaingr>PALO Phone </td>
		<td>
		<cfif not qry_last_submitted_data.RecordCount gt 0>
		...
		<td >
			<cfquery name="qry_lr_mgr" datasource="#datasrc#" username="lawmanager" password="zaq1xsw2ZAQ!XSW">
				select b.entity_key, initcap(first_name) ||' '|| initcap(last_name) as name from ENTITY a, cmft_entity b
				where b.entity_role = 'LRMGR' and a.entity_key = b.entity_key and b.group_prefix='SF' order by sort_fld                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              
			</cfquery>
			<cfif not qry_last_submitted_data.RecordCount gt 0>      
	...
	<tr>
		<td align="right" class=TextMaingr>PALO Fax </td>
		<td>
		<cfif not qry_last_submitted_data.RecordCount gt 0>
			<select name="alo_fax" size="1" tabindex=28>
					<option value="">Select One...</option>			
					<option value="562-628-1369">562-628-1369</option>
					<option value="415-550-5416" >415-550-5416</option>
					<option value="858-674-0610">858-674-0610</option>
			</select>
		<cfelse>
		<cfoutput>
			<select name="alo_fax" size="1" tabindex=28>
		...
		<td >                    
			<cfquery name="qry_hr_mgr" datasource="#datasrc#" username="lawmanager" password="zaq1xsw2ZAQ!XSW">
				select b.entity_key, initcap(first_name) ||' '|| initcap(last_name) as name from ENTITY a, cmft_entity b
				where b.entity_role = 'HRMGR' and a.entity_key = b.entity_key  and b.group_prefix = 'SF' order by sort_fld                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              
			</cfquery>
	...
	<tr>
		...
		<td width=30%>
			<cfquery name="qry_attorney" datasource="#datasrc#" username="lawmanager" password="zaq1xsw2ZAQ!XSW">
				select b.entity_key, initcap(first_name) ||' '|| initcap(last_name) as name 
				from ENTITY a, cmft_entity b
				where b.entity_role = 'ATTNY' and a.entity_key = b.entity_key and b.group_prefix = 'SF' order by sort_fld                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              
			</cfquery>
      ...
      <cfelse>      
		...
		<td >
			<cfquery name="qry_dist_mgr" datasource="#datasrc#" username="lawmanager" password="zaq1xsw2ZAQ!XSW">
				select b.entity_key, initcap(first_name) ||' '|| initcap(last_name) as name from ENTITY a, cmft_entity b
				where b.entity_role = 'DMGR' and a.entity_key = b.entity_key and b.group_prefix='SF' order by sort_fld                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              
			</cfquery>
	...
	<tr>
		...
		<td >     
			<cfquery name="qry_hr_mgr_dist" datasource="#datasrc#" username="lawmanager" password="zaq1xsw2ZAQ!XSW">
				select b.entity_key, initcap(first_name) ||' '|| initcap(last_name) as name from ENTITY a, cmft_entity b
				where b.entity_role = 'HRDST' and a.entity_key = b.entity_key and b.group_prefix='SF' order by sort_fld                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              
			</cfquery>
	...
	<tr>
		...
		<td width=30%>
			<cfquery name="qry_paralgl" datasource="#datasrc#" username="lawmanager" password="zaq1xsw2ZAQ!XSW">
				select b.entity_key, initcap(first_name) ||' '|| initcap(last_name) as name from ENTITY a, cmft_entity b
				where b.entity_role = 'PLGL' and a.entity_key = b.entity_key and b.group_prefix = 'SF' order by sort_fld                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              
			</cfquery>
      ...
      <cfelse>      
		...
		<td >
			<cfquery name="qry_ohna_dist" datasource="#datasrc#" username="lawmanager" password="zaq1xsw2ZAQ!XSW">
				select b.entity_key, initcap(first_name) ||' '|| initcap(last_name) as name from ENTITY a, cmft_entity b
				where b.entity_role = 'OHNA' and a.entity_key = b.entity_key and b.group_prefix='SF' order by sort_fld                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              
			</cfquery>
