component displayname="Master File Display MSPB Component" hint="Data access and helper functions for MSPB master file detail display." {
	 ...
	 * @entityRole The entity_role code (e.g., 'LRMGR', 'HRMGR', 'DMGR', etc.).
